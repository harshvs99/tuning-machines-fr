...
VALID_PASSWORD = "vc_password_123" 
...
def init_session_state():
    ...
    if "vc_thesis" not in st.session_state:
        st.session_state["vc_thesis"] = "Our fund invests in early-stage (Seed, Series A) B2B SaaS companies in North America with a strong technical founder."
